...
$stmt = $conn->query("
    INSERT INTO camps 
    (id,location, DATE, `startTime`,`endTime`, address, coordinator, expectedBeneficiaries, doctors, STATUS, beneficiaries) 
    VALUES ('','".$location."','".$date."','".$d1."','".$d2."','".$address."','".$coordinator."',".$expectedBeneficiaries.",'".$doctors."','".$status."','".$beneficiaries."')");
